...
ActiveRecord::Schema.define(version: 20190713025118) do
  ...
  create_table "address_clients", force: :cascade do |t|
    ...
    t.index ["address_id"], name: "index_address_clients_on_address_id", using: :btree
    t.index ["client_id"], name: "index_address_clients_on_client_id", using: :btree
  end
  ...
  create_table "schedulers", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["client_id"], name: "index_schedulers_on_client_id", using: :btree
    t.index ["service_id"], name: "index_schedulers_on_service_id", using: :btree
  end
  ...
  add_foreign_key "address_clients", "addresses"
